...
class QNet(nn.Module):
    def __init__(self, state_space_dim, action_space_dim):
        ...
        self.l1 = nn.Linear(state_space_dim, 32)
        self.l2 = nn.Linear(32, 32)
        self.l3 = nn.Linear(32, action_space_dim)
...
class QNetAgent():
    ...
    def __init__(self,state_space_dim, action_space_dim):
        self.sDim = state_space_dim
        self.aDim = action_space_dim
    ...
    def plot_durations(self,epi): # Update the plot at the end of each episode ## (I)
        ...
        elif EXPLORE_EPI_END <= epi <= TEST_EPI_START:
